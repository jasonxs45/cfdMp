const conMain = {
  ...
  name: 'P1+P2会议室1',
  figure: '可容纳150人',
  address: '武汉市洪山区关山大道322号',
  text: [
    { title: '空间设施', html: '<p>P4会议室占地总面积达100平方，位于际中心35楼。商务空间可容纳25人，是决策会议、策略会议的绝佳场地。 满足您的创意交流/研讨培训/大型报告、举办路演、发布会、公司年会/主题演讲、观影、小型话剧/脱口秀等一系列需求。</p>' },
